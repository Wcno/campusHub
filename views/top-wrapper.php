  ...
  <div class="link-wrapper">
    <div class="nav-links nav-links-main">
      <a
        ...
        class="sidebar-item <?php echo $currentPage == 'home.php' ? 'active' : '' ?>"><svg
      ...
      <?php if ($userRole == 'admin'): ?>
        ...
        <a
          href="../views/create_event.php"
          class="sidebar-item <?php echo $currentPage == '../views/create_event.php' ? 'active' : ''; ?>"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
            viewBox="0 0 24 24"
        ...
        <a
          href="#"
          class="sidebar-item <?php echo $currentPage == 'estadisticas.php' ? 'active' : ''; ?>"><svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
            viewBox="0 0 24 24"
      ...
      <a
        href="#"
        class="sidebar-item <?php echo $currentPage == 'misEventos.php' ? 'active' : ''; ?>"><svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
          viewBox="0 0 24 24"
    ...
    <div>
      <div class="nav-links">
        ...
        <a
          href="#"
          class="sidebar-item <?php echo $currentPage == 'ajustes.php' ? 'active' : ''; ?>">
