                ...
                <div>
                    <div class="banner planned-events">
                        ...
                        <div>
                            ...
                            <p class="about-data">Eventos <br> Publicados</p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="banner total-participants">
                        ...
                        <div>
                            ...
                            <p class="about-data">Participantes <br> Totales</p>
                        </div>
                    </div>
                ...
                <div>
                    <div class="banner total-locations">
                        ...
                        <div>
                            ...
                            <p class="about-data">Lugares <br> Anfitriones</p>
                        </div>
                    </div>
            ...
            <div class="info-events">
                <div class="info-event-item-container">
                    <div class="info-event-item">
                        <h3>Temática de evento con más concurrencia</h3>
                        <table>
                            <thead>
                                <tr>
                                    <th>Tema</th>
                        ...
                        <div class="upcoming-events">
                            ...
                            <?php foreach ($proximosEventos as $evento) : ?>
                                <div class="upcoming-event">
                                    <p class="upcoming-event-item"><span><?= $evento['title']; ?></span><span class="date-upcoming-event"><?= date("m/d/Y", strtotime($evento['date'])) ?></span></p>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
